...
class SFNet(nn.Module):
    def __init__(self, pretrained=True, num_class=1,bias = False):
        ...
        #                                  nn.ReLU(inplace=True)
        #                                  )
        self.conv_M512_128 = nn.Sequential(nn.Conv2d(512, 128, kernel_size=3, stride=1, padding=1, bias=bias),
                                         nn.BatchNorm2d(64),
                                         nn.ReLU(inplace=True)
                                         )
        self.conv_M512_128_2 = nn.Sequential(nn.Conv2d(512, 128, kernel_size=3, stride=1, padding=1, bias=bias),
                                         nn.BatchNorm2d(64),
                                         nn.ReLU(inplace=True)
                                         )
