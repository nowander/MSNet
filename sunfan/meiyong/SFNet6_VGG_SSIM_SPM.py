...
class SPM(nn.Module):
    def __init__(self, channel, ratio=16, is_more=1):
    ...
    def forward(self, *x):
        ...
        y1 = self.softmax(torch.matmul(x11, x22))
        if self.is_more:
            x3 = x[2]
...
class MFB(nn.Module):
    def __init__(self,inchannel):
        ...
        self.SPM = SPM(inchannel, is_more=1)
    ...
    def forward(self, *x):
        ...
        PAM1 = self.conv4(SPM1)
        CAM1 = self.conv5(SPM2)
        D5_1 = PAM1 + CAM1
